<div id="menu">
	...
	<div class="collapse navbar-collapse" id="menu_lista">
		<ul class="nav navbar-nav navbar-right">
			...
			<li><a href="?i=sugestao"><img src="../img/botao2.1.jpg"></a></li>
			<li><a href="?i=video"><img src="../img/botao3.jpg"></a></li>
...
<div id="middle">
	<form>
		...
		<div class="campo">
		    ...
		    <input type="text" id="email" name="email" style="width: 40em" value="" />
		</div>
		...
		<fieldset class="grupo">
		    ...
		    <div class="campo">
		        ...
		        <input type="text" id="assunto" name="assunto" style="width: 80em" value="" />
		    </div>
		</fieldset>
	...
	<div id="enviar">
      <input type="submit" name="botao" value="ENVIAR MINHA SUGESTÃO" class="botaoEnviar" />
   </div>
</div>
