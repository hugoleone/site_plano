...
<html lang="pt-br">
<head>
	<title>Plano Estadual de Segurança Pública do Amazonas</title>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="css/bootstrap-theme.min.css">
	<link rel="stylesheet" type="text/css" href="css/style.css">
	<link rel="stylesheet" type="text/css" href="css/nav.css">
	<link rel="shortcut icon" href="img/ssp.png" sizes="64x64" type="image/png">
...
<body>
	<header>
		<div class="testeira">
			<img src="img/testeira.jpg">
		</div>	
	</header>

	<div id="menu">
        <div class="navbar-header">
            <button type="button" style="margin-top: 25px" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#menu_lista" aria-expanded="true">
                <span style="background-color: #008506" class="icon-bar"></span>
                <span style="background-color: #008506" class="icon-bar"></span>
                <span style="background-color: #008506" class="icon-bar"></span>
            </button>
        </div>
